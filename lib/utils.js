...
exports.isValidAddress = function(addr, poolAddress){
    return (addr.length > 0) && (addr[0] === poolAddress[0]);
};
...
exports.diff1 = bignum('FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', 16);
