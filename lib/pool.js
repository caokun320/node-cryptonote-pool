...
BlockTemplate.prototype = {
    ...
    convertToCNBlob: function(job, extraNonce, nonceBuffer){
        ...
        return this.convertToCNHeader(originalHeader);
    },
    ...
    nextBlob: function(){
        ...
        return this.convertToCNBlob(this.jobTemplate, this.extraNonce, nonceBuffer);
    }
};
...
function processShare(miner, job, blockTemplate, nonce, resultHash){
    ...
    */
    ...
    if (shareTrustEnabled && miner.trust.threshold <= 0 && miner.trust.penalty <= 0 && Math.random() > miner.trust.probability){
        ...
        convertedBlob = blockTemplate.convertToCNBlob(blockTemplate.jobTemplate, job.extraNonce, Buffer.from(nonce, 'hex'));
        var cn_variant = 2;
