...
BlockTemplate.prototype = {
    convertToCNHeader: function(originalHeader){
        ...
        var nonce = Buffer.alloc(4, 0);
        current = Buffer.concat([current, nonce], 43);
    ...
    nextBlob: function(){
        ...
        extraNonce2Buffer.writeUInt32LE(this.extraNonce, 0);
        this.extraNonce ++;
        ...
        // TODO: is this right?
        var nTime = Date.now() / 1000 | 0;
        var nTimeBuffer = Buffer.alloc(4);
        nTimeBuffer.writeUInt32LE(nTime, 0);
